      ...
      <ContainerListeArticle>
        ...
        <RowArticle>
          ...
          >
            <article className="post-meta mt-30">
              <figure className="post-img m0">
                <Link to="/achat-immobilier/etapes-achat-immobilier" className="w-100 d-block">
                  <img
                    alt="trouver un notaire pour votre achat immobilier" src={img1}
                    className="w-100 tran4s"
                  />
              ...
              <div className="post-data">
                <h3 className="blog-title">
                  <Link to="/achat-immobilier/documents-de-vente-chez-le-notaire">Quelles sont les grandes étapes de votre achat immobilier ?</Link>
                </h3>
                ...
                <Link to="/achat-immobilier/etapes-achat-immobilier" className="read-btn tran3s">
                  En savoir plus
                </Link>
              </div>
              {/* <!-- /.post-data --> */}
          ...
          >
            <article className="post-meta mt-30">
              <figure className="post-img m0">
                <Link to="/notaires/domaines-competences-notaire" className="w-100 d-block">
                  <img
                    alt="trouver un notaire pour votre achat immobilier" src={img1}
                    className="w-100 tran4s"
                  />
              ...
              <div className="post-data">
                <h3 className="blog-title">
                  <Link to="/notaires/domaines-competences-notaire">Quels sont les domaines de compétences des notaires ?</Link>
                </h3>
                
                <p>Les notaires, souvent perçus comme de simples validateurs de documents, jouent en réalité un rôle bien plus vaste et crucial dans notre société
                </p>
                <Link to="/notaires/domaines-competences-notaire" className="read-btn tran3s">
                  En savoir plus
                </Link>
              </div>
              {/* <!-- /.post-data --> */}
